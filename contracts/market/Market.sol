...
contract Market is Node{
    ...
    function matchBidAndOffer(uint bid_index, uint offer_index) internal returns(bool) {
        OfferOrBid memory bid = bids[bid_index];
        OfferOrBid memory offer = offers[offer_index];
